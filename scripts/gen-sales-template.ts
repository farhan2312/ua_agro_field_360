...
const HEADERS = [
  "Retailer Name", "Order No", "Item Name", "MainCategory", "SubCategory",
...
const EXAMPLES = [
  ["RAM NAGAR ( BARABANKI )", "UAAG/15/2627/1", "MAIZE DEKALB DKC 9108 - 4.5 KG", "SEEDS",
    ...
    "SUBEDARPURWA", "", 0],
  ["RAM NAGAR ( BARABANKI )", "UAAG/15/2627/1", "N.P.K 16-16-16 (IPL) 50 KG", "FERTILIZER BULK",
